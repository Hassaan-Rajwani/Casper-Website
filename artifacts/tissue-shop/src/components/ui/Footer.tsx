      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                { href: "/products?category=facial", label: "Facial Tissue" },
                { href: "/products?category=kitchen", label: "Kitchen Rolls" },
                { href: "/products?category=toilet", label: "Toilet Paper" },
                { href: "/products?category=napkins", label: "Table Napkins" },
                { href: "/products?category=pocket", label: "Pocket Tissue" },
              ].map(link => (
                <li key={link.href}>
                  <Link href={link.href} className="text-sm text-muted-foreground hover:text-primary transition-colors">
                    {link.label}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3 text-sm text-muted-foreground">
                ...
                <span>0311-1234567<br/>Mon-Sat: 9am - 6pm</span>
              </li>
              <li className="flex items-start gap-3 text-sm text-muted-foreground">
                <Mail className="w-4 h-4 text-primary flex-shrink-0 mt-0.5" />
                <span>support@casper.pk</span>
              </li>
              <li className="flex items-start gap-3 text-sm text-muted-foreground">
        ...
        <div className="border-t border-border/50 mt-10 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-xs text-muted-foreground">
            © 2024 Casper. All rights reserved.
          </p>
